...
DmEfsFtruncateResponse::DmEfsFtruncateResponse(PacketEndianess targetEndian) : DmEfsPacket(targetEndian)
{
...
void DmEfsFtruncateResponse::unpack(std::vector<uint8_t>& data)
{
