...
*
* @file dm_efs_hotplug_device_info_request.h
...
using OpenPST::Qualcomm::DmEfsHotplugDeviceInfoResponse;

namespace OpenPST {
    namespace Qualcomm {
        
        class DmEfsHotplugDeviceInfoRequest : public DmEfsPacket
        {
            public:
                /**
                * @brief Constructor
                */
                DmEfsHotplugDeviceInfoRequest(PacketEndianess targetEndian = kPacketEndianessLittle);
