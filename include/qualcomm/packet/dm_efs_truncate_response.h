...
*
* @file dm_efs_truncate_response.h
...
namespace OpenPST {
    namespace Qualcomm {
        ...
        class DmEfsTruncateResponse : public DmEfsPacket
        {
            public:
                /**
                * @brief Constructor
                */
                DmEfsTruncateResponse(PacketEndianess targetEndian = kPacketEndianessLittle);
