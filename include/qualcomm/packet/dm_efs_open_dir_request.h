...
*
* @file dm_efs_open_dir_request.h
...
using OpenPST::Qualcomm::DmEfsOpenDirResponse;

namespace OpenPST {
    namespace Qualcomm {
        
        class DmEfsOpenDirRequest : public DmEfsPacket
        {
            public:
                /**
                * @brief Constructor
                */
                DmEfsOpenDirRequest(PacketEndianess targetEndian = kPacketEndianessLittle);
