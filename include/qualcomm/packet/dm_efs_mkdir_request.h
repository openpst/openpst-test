...
using OpenPST::Qualcomm::DmEfsMkdirResponse;

namespace OpenPST {
    namespace Qualcomm {
        
        class DmEfsMkdirRequest : public DmEfsPacket
        {
            public:
                /**
                * @brief Constructor
                */
                DmEfsMkdirRequest(PacketEndianess targetEndian = kPacketEndianessLittle);
