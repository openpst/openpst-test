...
*
* @file dm_efs_hotplug_format_response.h
...
namespace OpenPST {
    namespace Qualcomm {
        ...
        class DmEfsHotplugFormatResponse : public DmEfsPacket
        {
            public:
                /**
                * @brief Constructor
                */
                DmEfsHotplugFormatResponse(PacketEndianess targetEndian = kPacketEndianessLittle);
