...
*
* @file dm_efs_ftruncate_response.h
...
namespace OpenPST {
    namespace Qualcomm {
        ...
        class DmEfsFtruncateResponse : public DmEfsPacket
        {
            public:
                /**
                * @brief Constructor
                */
                DmEfsFtruncateResponse(PacketEndianess targetEndian = kPacketEndianessLittle);
