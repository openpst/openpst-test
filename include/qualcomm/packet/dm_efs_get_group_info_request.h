...
*
* @file dm_efs_get_group_info_request.h
...
using OpenPST::Qualcomm::DmEfsGetGroupInfoResponse;

namespace OpenPST {
    namespace Qualcomm {
        
        class DmEfsGetGroupInfoRequest : public DmEfsPacket
        {
            public:
                /**
                * @brief Constructor
                */
                DmEfsGetGroupInfoRequest(PacketEndianess targetEndian = kPacketEndianessLittle);
