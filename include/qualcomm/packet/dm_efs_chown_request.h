...
using OpenPST::Qualcomm::DmEfsChownResponse;

namespace OpenPST {
    namespace Qualcomm {
        
        class DmEfsChownRequest : public DmEfsPacket
        {
            public:
                /**
                * @brief Constructor
                */
                DmEfsChownRequest(PacketEndianess targetEndian = kPacketEndianessLittle);
