...
*
* @file dm_efs_hotplug_format_request.h
...
using OpenPST::Qualcomm::DmEfsHotplugFormatResponse;

namespace OpenPST {
    namespace Qualcomm {
        
        class DmEfsHotplugFormatRequest : public DmEfsPacket
        {
            public:
                /**
                * @brief Constructor
                */
                DmEfsHotplugFormatRequest(PacketEndianess targetEndian = kPacketEndianessLittle);
